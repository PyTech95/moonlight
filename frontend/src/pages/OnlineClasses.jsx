...
import { ArrowUpRight, Check, MapPin, CircleHelp, Video, Wifi, MessageCircle, ClipboardList, Sprout, CalendarCheck, ShieldCheck, Monitor } from 'lucide-react';
  ...
  return <>
      ...
      <div className="sport-hero-content">
        <Reveal>
          ...
          <div className="action-row">
            <button className="button primary" onClick={openBooking} data-testid="online-classes-enquire">Enquire about online classes <ArrowUpRight size={18}/></button>
    ...
    <section className="container service-detail section-pad">
      ...
      <aside className="service-aside">
        ...
        <button className="button primary full-width" onClick={openBooking} data-testid="online-aside-book">Request an online session <ArrowUpRight size={16}/></button>
